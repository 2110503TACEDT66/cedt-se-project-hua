    ...
    return(
            ...
            <div className="flex flex-col w-full h-64 rounded-lg shadow-lg bg-white">
                ...
                <div className="flex relative p-3 rounded-lg">
                    ...
                    <button onClick={() => {setRoom(RoomItem._id,RoomItem.roomNo)}} className="absolute bottom-2 right-2 rounded-xl py-2 px-3 text-white font-medium bg-purple-400 transition duration-100 hover:scale-105">Booking</button>
